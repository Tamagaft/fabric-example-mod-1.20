package net.tamagaft.testmod.block.custom;
...
import net.tamagaft.testmod.block.entity.GemPolishingStationBlockEntity;
...
public class GemPolishingStationBlock extends BlockWithEntity implements BlockEntityProvider {
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return validateTicker(type, ModBlockEntities.GOM_POLISHING_STATION_BLOCK_ENTITY,
