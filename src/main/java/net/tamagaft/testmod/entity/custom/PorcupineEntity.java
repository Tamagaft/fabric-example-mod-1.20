package net.tamagaft.testmod.entity.custom;
...
import net.tamagaft.testmod.entity.ai.PorcupineAttackGoal;
...
public class PorcupineEntity extends AnimalEntity {
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(1,new AnimalMateGoal(this, 10));
        this.goalSelector.add(2,new TemptGoal(this, 1.25, Ingredient.ofItems(ModItems.TOMATO),false));
    ...
    public static DefaultAttributeContainer.Builder createPorcupineAttributes(){
        return MobEntity.createMobAttributes()
                ...
                .add(EntityAttributes.GENERIC_MAX_ABSORPTION,5)
