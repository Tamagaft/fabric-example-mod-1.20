...
public enum ModArmorMaterials implements ArmorMaterial {
    RUBY("ruby",25,new int[]{3,8,6,3},19,
            SoundEvents.ITEM_ARMOR_EQUIP_TURTLE,2f,0.5f,()-> Ingredient.ofItems(ModItems.RUBY))
    ;
    ...
    ModArmorMaterials(String name, int durabilityMultiplier, int[] protectionAmounts, int echantability,
